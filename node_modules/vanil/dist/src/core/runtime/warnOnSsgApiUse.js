...
Vanil.fetchContent = (fileGlob) => {
    throw new Error(`Cannot fetchContent('${fileGlob}') at runtime (in browser). Please do: 
setPropsState({
...
/** throws an error with panic report explaining how to implement the logic wanted */
Vanil.resolve = (fileGlob) => {
    throw new Error(`Cannot resolve('${fileGlob}') at runtime (in browser). Please do: 
setPropsState({
